...
void Tentaculo::mueve(float t) {
	...
	e1.x = -(longitud / 6) + longitud*sin(a * pi / 180);		e1.y = (longitud) * (cos(-a * pi / 180));
	e2.x = (longitud / 6) + longitud*sin(a * pi / 180);			e2.y = (longitud) * (cos(-a * pi / 180));
	e3.x = -(longitud / 6) * cos(-a * pi / 180);				e3.y = -(longitud / 6) * (sin(-a * pi / 180));
	e4.x = (longitud / 6) * cos(-a * pi / 180);					e4.y = (longitud / 6) * (sin(-a * pi / 180));
	...
	e31.x = -(longitud / 6) + longitud * sin(a * pi / 180);			e31.y = (longitud) * (cos(-a * pi / 180));
	e41.x = (longitud / 6) + longitud * sin(a * pi / 180);			e41.y = (longitud) * (cos(-a * pi / 180));
	Vector2D e111 = { e11.x, e1.y+e11.y}, e211 = { e21.x, e2.y+e21.y };
	...
	Vector2D e121 = { e12.x, e111.y + e12.y }, e221 = { e22.x, e211.y + e22.y };
